...
export const BrowseTable = ({ section }) => {
			...
			<table className="table">
				<thead>
					<tr>
						<th>
							<button className="secondary_button mini-button" onClick={randomSelection} >
								<svg className="bi bi-shuffle" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
									<path fillRule="evenodd" d="M12.646 1.146a.5.5 0 01.708 0l2.5 2.5a.5.5 0 010 .708l-2.5 2.5a.5.5 0 01-.708-.708L14.793 4l-2.147-2.146a.5.5 0 010-.708zm0 8a.5.5 0 01.708 0l2.5 2.5a.5.5 0 010 .708l-2.5 2.5a.5.5 0 01-.708-.708L14.793 12l-2.147-2.146a.5.5 0 010-.708z" clip-rule="evenodd"></path>
						...
						<th>Category</th>
						<th>Section(s) found</th>
					</tr>
				</thead>
				<tbody>
					{categories.map(category => (<TableElement key={uuidv4()} section={section}
					category={category} />))}
				</tbody>
			</table>
		</div>
