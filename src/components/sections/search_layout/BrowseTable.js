...
export const BrowseTable = ({ styles, addStyle }) => {
			...
			<table className="table">
				<thead>
					<tr>
						...
						<th>Name</th>
						<th>Tags</th>
						<th>Found in section(s)</th>
					</tr>
				</thead>
				<tbody>
					{styles.map(style => (<TableElement key={style.id} style={style} addStyle={addStyle} />))}
				</tbody>
			</table>
		</div>
		)
